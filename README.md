...
Inconel718-Cutting  
│  
├── 01_Abaqus_FEM_ThermalMechanical_Cutting/   # 2023年1月：Abaqus 热-力耦合 FEM 切削仿真源文件  
│   ├── CAD_models/        # 几何与网格模型  
│   ├── Material_data/     # Inconel718 及刀具材料属性  
│   ├── Abaqus_input/      # Abaqus .inp 输入文件  
│   ├── Results/           # 切削力、温度场、切屑形貌等结果  
│   └── Report/            # 最终报告 PDF / Word / 演示文稿  
│  
├── 02_CuttingSim_ToolGeometry_Friction_Analysis/   # 2023年6月：CuttingSim 参数化刀具几何与摩擦分析  
│   ├── CuttingSim_inputs/ # 参数化配置文件  
│   ├── Data/              # 仿真输出数据（csv/txt）  
│   ├── Plots/             # 绘图脚本与结果曲线  
│   ├── Media/             # 结果图像、对比图、模型示意  
│   └── Report/            # 最终报告 PDF / 演示文稿  
│  
└── README.md              # 项目总览与说明
